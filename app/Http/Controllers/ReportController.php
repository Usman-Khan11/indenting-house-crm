        ...
        if ($request->ajax()) {
            $query = Inquiry::join('inquiry_items', 'inquiries.id', '=', 'inquiry_items.inquiry_id')
                ...
                ->select(
                    ...
                    'inquiries.sales_person as sales_person',
                    'suppliers.name as supplier_name',
                    'inquiries.sourcing_person as sourcing_person',
        ...
        if ($request->ajax()) {
            $query = Offer::join('offer_items', 'offers.id', '=', 'offer_items.offer_id')
                ...
                ->select(
                    ...
                    'offers.sales_person as sales_person',
                    'suppliers.name as supplier_name',
                    'offers.sourcing_person as sourcing_person',
                    'products.name as product_name',
        ...
        if ($request->ajax()) {
            $query = PurchaseOrder::join('purchase_order_items', 'purchase_orders.id', '=', 'purchase_order_items.po_id')
                ...
                ->select(
                    ...
                    'customers.name as customer_name',
                    'purchase_orders.sales_person as sales_person',
                    'suppliers.name as supplier_name',
                    'purchase_orders.sourcing_person as sourcing_person',
                    'products.name as product_name',
        ...
        if ($request->ajax()) {
            $query = Indent::join('indent_items', 'indents.id', '=', 'indent_items.indent_id')
                ...
                ->select(
                    ...
                    'indent_items.*',
                    'customers.name as customer_name',
                    'indents.sales_person as sales_person',
                    'suppliers.name as supplier_name',
                    'indents.sourcing_person as sourcing_person',
                    'products.name as product_name',
