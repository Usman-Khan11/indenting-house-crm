                    ...
                    <div class="row">
                        <div class="col-md-2 col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="offer_no" value="{{ $offer->offer_no }}" class="form-control"
                                    readonly />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="mb-3">
                                ...
                                <input type="date" required name="date" value="{{ old('date', $offer->date) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="select2 form-select" name="inquiry_id" required
                                    ...
                                    @foreach ($inquiries as $inquiry)
                                        <option @if (old('inquiry_id', $offer->inquiry_id) == $inquiry->id) selected @endif
                        ...
                        <div class="col-md-3 col-12">
                            <div class="mb-3">
                                ...
                                <input type="date" name="validity" value="{{ old('validity', $offer->validity) }}"
                            ...
                            <div class="mb-3">
                                ...
                                <select class="select2 form-select currency" name="currency">
                                    @foreach (currency() as $key => $value)
                                        <option @if (old('currency', $offer->currency) == $key) selected @endif
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-3">
                                ...
                                <select class="select2 form-select customer_id" name="customer_id" required disabled
                                    onchange="getCustomerProducts(this)">
                                    <option selected disabled value="">Select Customer</option>
                                    @foreach ($customers as $customer)
                                        <option @if (old('customer_id', $offer->customer_id) == $customer->id) selected @endif
                            ...
                            <div class="mb-3">
                                ...
                                <select class="select2 form-select supplier_id" name="supplier_id" required disabled>
                                    ...
                                    @foreach ($suppliers as $supplier)
                                        <option @if (old('supplier_id', $offer->supplier_id) == $supplier->id) selected @endif
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="signature" value="{{ old('signature', $offer->signature) }}"
                        ...
                        <div class="col-md-4 col-12">
                            <a href="" class="btn btn-primary mt-3">Send Email to Customer</a>
                        </div>
