<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @if($value->nav_id == 2 && (in_array('view', Get_Permission($value->nav_id, auth()->user()->role_id)) || in_array('map product', Get_Permission($value->nav_id, auth()->user()->role_id))))
        ...
        @if($value->nav_id == 3 && (in_array('view', Get_Permission($value->nav_id, auth()->user()->role_id)) || in_array('map product', Get_Permission($value->nav_id, auth()->user()->role_id))))
