    ...
    <div class="invoice-print p-4">
                ...
                <div class="col-6">
                    <table class="table table-bordered table-sm border-dark">
                        <tbody>
                            <tr>
                                <td width="60%">
                                    <h5 class="mb-1"><b>Shipment Date:</b> &nbsp; {{ ($shipment->date) ? date("d-M-Y", strtotime($shipment->date)) : '-' }}</h5>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                    ...
                    <table class="table table-bordered table-sm border-dark align-top">
                        <tbody>
                            <tr>
                                ...
                                <td width="15%">
                                    <p class="m-0">{{ ($shipment->lc_issue_date) ? date("d-M-Y", strtotime($shipment->lc_issue_date)) : '-' }}</p>
                                </td>
                                <td width="18.33%">
        ...
        <div class="">
            <div class="row">
                ...
                <div class="col-6">
                    <div class="border border-dark p-2 pb-5 pt-2">
                        <h5 class="mb-1">Sign & Stamp: <small>(For <b>{{ @$shipment->customer->name }}</b>)</span></h5>
                        <br /><br /><br />
                    </div>
                </div>
            </div>
