                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            ...
                            <input name="location" type="text" class="form-control" value="{{ old('location') }}" placeholder="Location" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            ...
                            <input name="fax_number" type="text" class="form-control" value="{{ old('fax_number') }}" placeholder="Fax Number" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            ...
                            <input name="person_3" type="text" class="form-control" value="{{ old('person_3') }}" placeholder="Sales Person" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            ...
                            <input name="cell_1" type="number" class="form-control" value="{{ old('cell_1') }}" placeholder="Cell No" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            <label class="form-label">Cell No</label>
                            <input name="cell_2" type="number" class="form-control" value="{{ old('cell_2') }}" placeholder="Cell No" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            <label class="form-label">Cell No</label>
                            <input name="cell_3" type="number" class="form-control" value="{{ old('cell_3') }}" placeholder="Cell No" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            ...
                            <input name="phone_1" type="number" class="form-control" value="{{ old('phone_1') }}" placeholder="Phone" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-12">
                        <div class="mb-3">
                            <label class="form-label">Phone</label>
                            <input name="phone_2" type="number" class="form-control" value="{{ old('phone_2') }}" placeholder="Phone" />
                        </div>
                    </div>
