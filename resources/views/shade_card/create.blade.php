...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <form method="post" action="{{ route('shade_card.store') }}" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-3">
                                ...
                                <input name="artwork_no" type="text" class="form-control" placeholder="Artwork No" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-3">
                                ...
                                <select name="artwork_status" class="form-select">
                                    <option @if (old('artwork_status') == '1') selected @endif value="1">Approved
                                    </option>
                                    <option @if (old('artwork_status') == '2') selected @endif value="2">Pending at
                                        Supplier</option>
                                    <option @if (old('artwork_status') == '3') selected @endif value="3">Pending at
                                        Customer</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-3">
                                ...
                                <select name="print_style" class="form-select">
                                    <option @if (old('print_style') == '1') selected @endif value="1">Axial Not
                                        Rectified</option>
                                    <option @if (old('print_style') == '2') selected @endif value="2">Radial Not
                                        Rectified</option>
                                    <option @if (old('print_style') == '3') selected @endif value="3">Not Known
                                    </option>
                                    <option @if (old('print_style') == '4') selected @endif value="4">Axial
                                        Rectified</option>
                                    <option @if (old('print_style') == '5') selected @endif value="5">Radial
                                        Rectified</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="mb-3">
                                ...
                                <input name="front_print" type="text" class="form-control"
                                    value="{{ old('front_print') }}" placeholder="Front Print" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="mb-3">
                                ...
                                <input name="front_print_color" type="text" class="form-control"
                                    value="{{ old('front_print_color') }}" placeholder="Front Print Color" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="mb-3">
                                ...
                                <input name="back_print" type="text" class="form-control" value="{{ old('back_print') }}"
                                    placeholder="Back Print" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="mb-3">
                                ...
                                <input name="back_print_color" type="text" class="form-control"
                                    value="{{ old('back_print_color') }}" placeholder="Back Print Color" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="mb-3">
                                ...
                                <textarea name="remarks" rows="5" class="form-control" placeholder="Remarks">{{ old('remarks') }}</textarea>
                            </div>
                        </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="select2 form-select size_id" name="size_id" required>
                                    ...
                                    @foreach ($sizes as $size)
                                        <option @if (old('size_id') == $size->id) selected @endif
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-3">
                                ...
                                <input name="ingredient" type="text" class="form-control"
                                    value="{{ old('ingredient') }}" placeholder="Ingredient" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="mb-3">
                                ...
                                <input name="front_color" type="text" class="form-control"
                                    value="{{ old('front_color') }}" placeholder="Front Color" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="mb-3">
                                ...
                                <input name="front_code" type="text" class="form-control"
                                    value="{{ old('front_code') }}" placeholder="Front Code" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="mb-3">
                                ...
                                <input name="back_color" type="text" class="form-control"
                                    value="{{ old('back_color') }}" placeholder="Back Color" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-3">
                                ...
                                <select name="card_status" class="form-select">
                                    <option @if (old('card_status') == '1') selected @endif value="1">Approved
                                    </option>
                                    <option @if (old('card_status') == '2') selected @endif value="2">Pending at
                                        Supplier</option>
                                    <option @if (old('card_status') == '3') selected @endif value="3">Pending at
                                        Customer</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-3">
                                ...
                                <input name="ref_code" type="text" class="form-control"
                                    value="{{ old('ref_code') }}" placeholder="Ref Code" />
                            </div>
                        </div>
