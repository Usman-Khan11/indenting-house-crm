<div class="row align-items-center border border-primary py-2 mb-3">
    ...
    <div class="col-md-2 mb-3">
        ...
        <input type="text" name="product_delivery[]" value="{{ $product_delivery }}" class="form-control product_delivery">
    </div>
    ...
    <div class="col-md-3 mb-3">
        ...
        <select name="product_supplier[]" class="form-select select2 product_supplier" required>
            ...
            <option @if($product_supplier==$supplier->id) selected @endif value="{{ $supplier->id }}">{{ $supplier->name }}</option>
            @endforeach
        </select>
    </div>
</div>