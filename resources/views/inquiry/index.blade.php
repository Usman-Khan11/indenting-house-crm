            ...
            var datatable = $("#my_table").DataTable({
                ...
                columns: [{
                        ...
                        render: function(data, type, full, meta) {
                            let button = '';
                            button +=
                                `<a href="/inquiry/view/${full.id}" target="_blank" class="btn btn-info btn-xs">View</a> `;
                            button +=
                                `<a href="/inquiry/edit/${full.id}" class="btn btn-warning btn-xs">Edit</a> `;
                            button +=
                                `<a onclick="return checkDelete()" href="/inquiry/delete/${full.id}" class="btn btn-danger btn-xs">Delete</a> `;
                    ...
                    },
                    {
                        ...
                        title: "Inquiry #",
                        render: function(data, type, full, meta) {
                            if (full.offer && full.offer.po && full.offer.po.indent) {
