...
@push('script')
    <script type="text/javascript">
        $(document).ready(function() {
            let title = 'Shade Card & Artwork Report';
            let filename = 'shade-card-report';
            ...
            $("#filter_btn").click(function() {
                ...
                title = `Shade Card & Artwork Report ${from} to ${to}`;
            })
        });
    </script>
@endpush
