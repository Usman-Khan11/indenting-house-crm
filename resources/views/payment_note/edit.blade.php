...
<div class="container-xxl flex-grow-1 container-p-y">
    <form method="post" action="{{ route('payment_note.update') }}" enctype="multipart/form-data">
        @csrf
                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="mb-3">
                            ...
                            <textarea name="text" class="form-control editor" placeholder="Payment Note*">@php echo old('text', $note->text); @endphp</textarea>
                        </div>
                    </div>
