                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-3">
                                ...
                                <input name="fax_number" type="number" class="form-control" value="{{ old('fax_number') }}"
                        ...
                        <div class="col-md-12 col-12">
                            <div class="mb-3">
                                ...
                                <textarea name="sourcing_person" class="form-control" placeholder="Sourcing Person">{{ old('sourcing_person') }}</textarea>
                        ...
                        <div class="col-md-4 col-12">
                            <div class="mb-3">
                                ...
                                <input name="swift_code" type="text" class="form-control"
                                    value="{{ old('swift_code') }}" placeholder="Swift Code" />
                            </div>
                        </div>
