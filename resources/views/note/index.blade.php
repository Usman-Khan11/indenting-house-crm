        ...
        <div class="card-header">
            <div class="row align-items-center">
                ...
                <div class="col-6 text-end">
                    <a href="{{ route('note.create') }}" class="btn btn-primary">Add New Note</a>
                </div>
            </div>
            <hr />
        </div>
        ...
        var datatable = $("#my_table").DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, full, meta) {
                        let button = '';
                        button += `<a href="/note/edit/${full.id}" class="btn btn-warning btn-sm">Edit</a> `;
                        button += `<a onclick="return checkDelete()" href="/note/delete/${full.id}" class="btn btn-danger btn-sm">Delete</a> `;
